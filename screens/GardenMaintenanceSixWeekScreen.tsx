...
const GardenMaintenanceSixWeekScreen: React.FC = () => {
  ...
  const curriculumData = [
    ...
    { title: "Week 2: Pruning and Plant Care", description: "Learn the art and science of pruning and plant care.", points: ["Techniques for pruning shrubs, trees, and plants", "Understanding plant growth cycles", "Identifying and managing pests and diseases", "Methods for nurturing plants"] },
    { title: "Week 3: Lawn Care and Maintenance", description: "Focus on the specific needs of lawn care.", points: ["Basics of lawn care: mowing, edging, fertilization", "Techniques for controlling weeds and pests", "Understanding different grass types", "Seasonal lawn care practices"] },
    { title: "Week 4: Irrigation and Water Management", description: "Learn effective irrigation techniques and water management.", points: ["Overview of irrigation systems", "Techniques for efficient water use", "Designing and installing irrigation systems", "Troubleshooting and maintenance"] },
    { title: "Week 5: Composting and Soil Health", description: "Explore composting methods and soil health practices.", points: ["Basics of composting: types and processes", "Techniques for creating healthy compost", "Understanding and testing soil health", "Benefits of composting and organic matter"] },
    { title: "Week 6: Seasonal Garden Planning", description: "Learn how to plan and manage your garden throughout the year.", points: ["Planning garden tasks by season", "Strategies for crop rotation and bed management", "Preparing for seasonal changes", "Long-term garden management"] },
  ];
